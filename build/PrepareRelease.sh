...
actualPatchNumber=${versionNumbersArray[2]}
nextPatchNumber=$(expr $actualPatchNumber + 1)
echo "Actual version is: Major ${versionNumbersArray[0]}, Minor ${versionNumbersArray[1]}, Patch $actualPatchNumber"
echo "Next version is: Major ${versionNumbersArray[0]}, Minor ${versionNumbersArray[1]}, Patch $nextPatchNumber"
nextVersionInfo="${versionNumbersArray[0]}.${versionNumbersArray[1]}.$nextPatchNumber"
